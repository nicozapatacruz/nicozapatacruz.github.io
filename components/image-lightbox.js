...
(function() {
  function initLightbox() {
    ...
    style.textContent = `
      ...
      .img-full, .img-pair img, .img-trio img, .img-grid img, .img-grid-3 img, .project-img {
        cursor: zoom-in;
    ...
    function attachToImages() {
      const selectors = '.img-full, .img-pair img, .img-trio img, .img-grid img, .img-grid-3 img, .project-img';
