  ...
  function initLightbox() {
    ...
    overlay.innerHTML = `
      ...
      @media (max-width: 768px) {
        ...
        #lightbox-inner { max-width: 100vw; max-height: 100vh; gap: 0; }
        #lightbox-img { max-width: 100vw; max-height: 90vh; border-radius: 0; }
        #lightbox-close { top: 1rem; right: 1rem; background: rgba(0,0,0,0.4); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; }
