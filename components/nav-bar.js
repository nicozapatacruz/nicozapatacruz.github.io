  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <nav>
        ...
        <ul class="nav-links">
          ...
          <li class="nav-dropdown">
            <button class="nav-drop-btn">Work <svg class="drop-arrow" width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L5 5L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
      ...
      <style>
        ...
        .drop-arrow { display: inline-block; vertical-align: middle; margin-left: 2px; transition: transform 0.2s; }
