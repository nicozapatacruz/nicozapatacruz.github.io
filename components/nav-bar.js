class NavBar extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <div class="mobile-menu">
        <div class="mobile-menu-inner">
          ...
          <a href="${base}index.html#contact" class="mobile-cta">Let's talk</a>
        </div>
      </div>
      ...
      <style>
        ...
        .mobile-cta {
          position: fixed;
          bottom: 2rem; right: clamp(1.5rem, 5vw, 2.5rem);
        ...
        .mobile-cta:hover { background: #2B4FFF; }
    ...
    hamburger.addEventListener('click', () => {
      ...
      mobileCta.classList.toggle('visible', isOpen);
    });
    ...
    // Hide cta on mobile-cta click too
